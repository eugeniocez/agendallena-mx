...
export const FeedStep2: React.FC = () => {
  ...
  const MSG = "Hola María, tu cita en Studio Dental está confirmada para el miércoles 7 de mayo a las 10:00 am. ¡Te esperamos!";
  const chars = Math.floor(
    MSG.length *
      interpolate(frame, [32, 95], [0, 1], {
        extrapolateLeft: "clamp",
        extrapolateRight: "clamp",
        easing: Easing.bezier(0.22, 1, 0.36, 1),
      })
